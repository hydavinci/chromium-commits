...
def demonstrate_chromium_commit_fetcher():
    ...
    for file_path in example_file_paths:
        ...
        if latest_commit_info:
            ...
            commit_message = latest_commit_info.get('message', 'N/A').strip().split('\n')[0]  # Only take the first line
            ...
            formatted_commit_info = commit_fetcher.get_file_commit_info(file_path, detailed=True, show_diff=False)
